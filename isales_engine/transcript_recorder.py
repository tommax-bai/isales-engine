    ...
    *,
    ...
    for trace_dict in session.pipeline_trace_records:
        trace = PipelineTrace(
            ...
            role_candidates=trace_dict.get("role_candidates") or [],
            judge_results=trace_dict.get("judge_results") or [],
            polish_input=trace_dict.get("polish_input"),
            polish_output=trace_dict.get("polish_output"),
            polish_duration_ms=trace_dict.get("polish_duration_ms"),
            polish_role_config_id=trace_dict.get("polish_role_config_id"),
            polish_prompt_version_id=trace_dict.get("polish_prompt_version_id"),
            final_selected_candidate_index=trace_dict.get("final_selected_candidate_index"),
        )
        db.add(trace)
