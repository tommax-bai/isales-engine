    ...
    *,
    ...
    for trace_dict in session.pipeline_trace_records:
        trace = PipelineTrace(
            ...
            referee_results=trace_dict.get("referee_results") or [],
            matched_rule=trace_dict.get("matched_rule"),
            restructure_active=bool(trace_dict.get("restructure_active") or False),
            restructure_trigger=trace_dict.get("restructure_trigger"),
            restructure_source_text=trace_dict.get("restructure_source_text"),
